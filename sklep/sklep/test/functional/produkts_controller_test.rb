...
class ProduktsControllerTest < ActionController::TestCase
  ...
  test "should create produkt" do
    assert_difference('Produkt.count') do
      post :create, produkt: { cena: @produkt.cena, img_url: @produkt.img_url, nazwa: @produkt.nazwa, opis: @produkt.opis }
    end
  ...
  test "should update produkt" do
    put :update, id: @produkt, produkt: { cena: @produkt.cena, img_url: @produkt.img_url, nazwa: @produkt.nazwa, opis: @produkt.opis }
    assert_redirected_to produkt_path(assigns(:produkt))
  end
